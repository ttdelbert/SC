...
function createOrg1() {
  infoln "Enrolling the Org1_CA admin"
  ...
  ###############new added commands begin################
  infoln "Enrolling the tls_Org1_CA admin"
  mkdir -p organizations/peerOrganizations/tls-org1.example.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/tls-org1.example.com/

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:12054 --caname tls-ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org1/tls-cert.pem"
  { set +x; } 2>/dev/null
  
  infoln "Registering peer0(for tls)"
  set -x
  fabric-ca-client register --caname tls-ca-org1 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org1/tls-cert.pem"
  { set +x; } 2>/dev/null
  ###############new added commands end###############

  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:12054 --caname tls-ca-org1 -M "${PWD}/organizations/peerOrganizations/tls-org1.example.com/peers/peer0.org1.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org1.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org1/tls-cert.pem"
  { set +x; } 2>/dev/null

################copy brand-new generated tls-content to old path############
  cp -rf "${PWD}/organizations/peerOrganizations/tls-org1.example.com/peers/peer0.org1.example.com/tls/" "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/"
...
#########modify user1 privateKey's name for caliper#########		  
  mv "${PWD}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/"* "${PWD}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/priv_sk"
...
function createOrg2() {
  infoln "Enrolling the Org2_CA admin"
  ...
  ###############new added commands begin################
  infoln "Enrolling the tls_Org2_CA admin"
  mkdir -p organizations/peerOrganizations/tls-org2.example.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/tls-org2.example.com/

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:13054 --caname tls-ca-org2 --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org2/tls-cert.pem"
  { set +x; } 2>/dev/null
  
  infoln "Registering peer0(for tls)"
  set -x
  fabric-ca-client register --caname tls-ca-org2 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org2/tls-cert.pem"
  { set +x; } 2>/dev/null
  ###############new added commands end###############

  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:13054 --caname tls-ca-org2 -M "${PWD}/organizations/peerOrganizations/tls-org2.example.com/peers/peer0.org2.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org2.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org2/tls-cert.pem"
  { set +x; } 2>/dev/null

################copy brand-new generated tls-content to old path############
  cp -rf "${PWD}/organizations/peerOrganizations/tls-org2.example.com/peers/peer0.org2.example.com/tls/" "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/"
...
#########modify user1 privateKey's name for caliper#########		  
  mv "${PWD}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/"* "${PWD}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/priv_sk"
...
function createOrg3() {
  infoln "Enrolling the Org3_CA admin"
  ...
  ###############new added commands begin################
  infoln "Enrolling the tls_Org3_CA admin"
  mkdir -p organizations/peerOrganizations/tls-org3.example.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/tls-org3.example.com/

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:14054 --caname tls-ca-org3 --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  
  infoln "Registering peer0(for tls)"
  set -x
  fabric-ca-client register --caname tls-ca-org3 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ###############new added commands end###############

  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:14054 --caname tls-ca-org3 -M "${PWD}/organizations/peerOrganizations/tls-org3.example.com/peers/peer0.org3.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org3.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/tls-org3/tls-cert.pem"
  { set +x; } 2>/dev/null

################copy brand-new generated tls-content to old path############
  cp -rf "${PWD}/organizations/peerOrganizations/tls-org3.example.com/peers/peer0.org3.example.com/tls/" "${PWD}/organizations/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/"
...
#########modify user1 privateKey's name for caliper#########		  
  mv "${PWD}/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/keystore/"* "${PWD}/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/keystore/priv_sk"
...
function createOrderer() {
  infoln "Enrolling the Orderer_CA admin"
  ...
  ###############new added commands begin################
  infoln "Enrolling the tls_Orderer_CA admin"
  mkdir -p organizations/ordererOrganizations/tls.example.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/ordererOrganizations/tls.example.com/

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:15054 --caname tls-ca-orderer --tls.certfiles "${PWD}/organizations/fabric-ca/tls-orderer/tls-cert.pem"
  { set +x; } 2>/dev/null
  
  infoln "Registering orderer(for tls)"
  set -x
  fabric-ca-client register --caname tls-ca-orderer --id.name orderer --id.secret ordererpw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/tls-orderer/tls-cert.pem"
  { set +x; } 2>/dev/null
  ###############new added commands end###############
  
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:15054 --caname tls-ca-orderer -M "${PWD}/organizations/ordererOrganizations/tls.example.com/orderers/orderer.example.com/tls" --enrollment.profile tls --csr.hosts orderer.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/tls-orderer/tls-cert.pem"
  { set +x; } 2>/dev/null

################copy brand-new generated tls-content to old path############
  cp -rf "${PWD}/organizations/ordererOrganizations/tls.example.com/orderers/orderer.example.com/tls/" "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/"
