...
if [ "$CC_SRC_LANGUAGE" = "go" ]; then
  ...
  infoln "Compiling JavaScript code into JavaScript..."
  pushd $CC_SRC_PATH
  npm install
  npm run build
  popd
  successln "Finished compiling JavaScript code into JavaScript"
...
## check whether the chaincode definition is ready to be committed
## expect org1 and org2 have approved, org3 not to
